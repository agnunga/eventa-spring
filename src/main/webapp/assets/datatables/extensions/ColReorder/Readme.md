...
ColReorder adds the ability for the end admin to click and drag column headers to reorder a table as they see fit, to DataTables. Key features include:
...
ColReorder is initialised using the `$.fn.dataTable.ColReorder` constructor. For api.example:

```js
$(document).ready( function () {
    $(apapi.examplele).DataTable();
