...
angular.module("account/login.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("account/login.tpl.html",
    "<div id=\"result\"></div>\n" +
    "<form ng-submit=\"login()\" id=\"login_form\" class=\"well form-horizontal\" method=\"post\" style=\"max-width: 700px; margin: 50px auto auto auto;\">\n" +
    "    <fieldset>\n" +
    ...
    "                    <input ng-model=\"account.phone\" name=\"phone\" placeholder=\"Phone Number\" class=\"form-control\" type=\"text\" required autofocus>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"form-group\">\n" +
    ...
    "            <div class=\"col-md-4 inputGroupContainer\">\n" +
    "                <div class=\"input-group\">\n" +
    "                    <input ng-model=\"account.password\" name=\"password\" placeholder=\"\" class=\"form-control\" type=\"password\" required>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"form-group\">\n" +
...
angular.module("account/register.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("account/register.tpl.html",
    "<div id=\"result\"></div>\n" +
    "<form ng-submit=\"register()\" id=\"add_user\" role=\"form\" data-toggle=\"validator\"  method=\"post\" class=\"well form-horizontal\">\n" +
    "    <fieldset>\n" +
    "        <legend style=\"text-align: center;\">Register</legend>\n" +
    "        <div class=\"form-group\">\n" +
    "            <label class=\"control-label col-sm-3\">First Name : </label>\n" +
    "            <div class=\"col-sm-9\">\n" +
    "                <input ng-model=\"account.firstName\" type=\"text\" name=\"firstName\" id=\"firstName\" class=\"form-control\" autofocus/>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"form-group\">\n" +
    "            <label class=\"control-label col-sm-3\">Last Name : </label>\n" +
    "            <div class=\"col-sm-9\">\n" +
    "                <input ng-model=\"account.lastName\" type=\"text\" name=\"lastName\" id=\"lastName\" class=\"form-control\"/>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"form-group\">\n" +
    "            <label class=\"control-label col-sm-3\">Phone : </label>\n" +
    "            <div class=\"col-sm-9\">\n" +
    "                <input ng-model=\"account.phone\" type=\"text\" name=\"phone\"  id=\"phone\" class=\"form-control\"/>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"form-group\">\n" +
    "            <label class=\"control-label col-sm-3\">Email : </label>\n" +
    "            <div class=\"col-sm-9\">\n" +
    "                <input ng-model=\"account.email\" type=\"text\" name=\"email\"  id=\"email\" class=\"form-control\"/>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"form-group\">\n" +
    "            <label class=\"control-label col-sm-3\">Gender : </label>\n" +
    "            <div class=\"col-sm-9\">\n" +
    "                <label class=\"radio-inline\"><input ng-model=\"account.gender\" type=\"radio\" name=\"gender\" value=\"MALE\">Male</label>\n" +
    "                <label class=\"radio-inline\"><input ng-model=\"account.gender\" type=\"radio\" name=\"gender\" value=\"FEMALE\">Female</label>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"form-group\">\n" +
...
angular.module("home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/home.tpl.html",
    ...
    "  </ul> -->\n" +
    "  \n" +
    "  <div ng-hide=\"isLoggedIn()\" class=\"btn-group\">\n" +
    "    <a ui-sref=\"register\" class=\"btn btn-large btn-default\">\n" +
    "      <i class=\"fa fa-book\"></i>\n" +
    "      Register\n" +
    "    </a>\n" +
    "    <a ui-sref=\"login\" class=\"btn btn-large btn-success\">\n" +
