...
ColVis adds a button to the toolbars around DataTables which gives the end admin of the table the ability to dynamically change the visibility of the columns in the table:
